...
#include <vector>
#include <string>
//  한 변의 길이가 n인 정사각형 배열 형태인 지도, 각 칸은 " "(공백) 또는 "#"(벽) 두 종류
//  지도 2장을 겹처서 전체 지도를 만든다.

// 비트 연산을 묻는 문제다.
std::vector<std::string> secretMap(int n, std::vector<int> arr1, std::vector<int> arr2)
{
    std::vector<std::string> result;
    // 지도는 가로 한줄씩 정수 bit로 이루어져 있다. 1은 벽 0은 공백이다.
